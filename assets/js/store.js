(() => {
  ...
  const STORAGE_KEY = 'oatf-os-production-v012';
  const LEGACY_KEYS = ['oatf-os-production-v011','oatf-os-production-v010','oatf-os-production-v009','oatf-os-production-v008','oatf-os-production-v007','oatf-os-production-v006','oatf-os-production-v005','oatf-os-production-v004','oatf-os-production-v003','oatf-admin-v002','oatf-admin-v001'];
  ...
  const seed = {
    ...
    changeSets:[],
    incidents:[
      {id:'incident-seed-1',fairId:'fair-oc',kind:'Decision',severity:'Info',title:'Public schedule remains protected',detail:'Do not publish another schedule revision until missing performer materials are resolved.',status:'Logged',occurredAt:'2026-07-18T15:58:00-07:00',createdAt:'2026-07-18T15:58:00-07:00',updatedAt:'2026-07-18T15:58:00-07:00'}
    ],
    packageHistory:[],
    spaces:[
  ...
  function upgradeState(input){
    ...
    upgraded.meta = {...(upgraded.meta || {}),version:'0.12',portal:'production',releaseChannel:'candidate'};
    ...
    upgraded.stateCaptures = Array.isArray(upgraded.stateCaptures) ? upgraded.stateCaptures : [];
    upgraded.changeSets = Array.isArray(upgraded.changeSets) ? upgraded.changeSets : [];
    ...
    upgraded.preferences.sidebarBehavior = upgraded.preferences.sidebarBehavior || 'auto';
    upgraded.preferences.mediumDesktopDensity = upgraded.preferences.mediumDesktopDensity || 'balanced';
    upgraded.preferences.shellTourDismissed = Boolean(upgraded.preferences.shellTourDismissed);
    upgraded.preferences.v12SimplifiedApplied = Boolean(upgraded.preferences.v12SimplifiedApplied);
    upgraded.preferences.dashboardDensity = upgraded.preferences.dashboardDensity || 'focused';
    upgraded.preferences.actionBoardMode = upgraded.preferences.actionBoardMode || 'guided';
  ...
  function getCollection(type){
    const map = {fair:'fairs',contact:'contacts',talent:'talent',task:'tasks',schedule:'schedules',deadline:'deadlines',file:'files',note:'notes',issue:'issues',handoff:'handoffs',scenario:'scenarios',decision:'decisions',capture:'stateCaptures',changeset:'changeSets',incident:'incidents',package:'packageHistory',space:'spaces',activity:'activity'};
